...
const menuItems = [
  { id: 'feed', name: 'Моя лента', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10', active: true },
  { id: 'analytics', name: 'Статистика', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', active: false },
  { id: 'scenarios', name: 'Сценарии', icon: 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z', active: false },
    ...
    <nav class="flex-1 px-4 py-8 space-y-2">
      ...
      >
        <svg 
          ...
          viewBox="0 0 24 24" 
          stroke="currentColor"
          :class="item.active ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600'"
        >
